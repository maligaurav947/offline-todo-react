            ...
            <Card key={index} color={color} fluid style={cardBackground}>
              <Card.Content>
                ...
                <Card.Meta textAlign="right">
                  <Icon link name="check circle" color="green" />
                  <span
                  ...
                  <Icon link name="undo" color="yellow" />
                  <span
                    style={{ paddingRight: 10 }}
        ...
        <div>
          <Header as="h1">
            <div className="app-header">
              Offline TODO App the browser using React JS
            </div>{" "}
          </Header>
        ...
        <div className="app-form">
          <Form onSubmit={this.onSubmit}>
            <Input
              ...
              fluid
              placeholder="Drop Your List Here.."
            />
          </Form>
        </div>
